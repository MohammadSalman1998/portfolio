            ...
            <div className=" content relative flex justify-between">
                ...
                <div className="right h-screen w-1/2 relative overflow-hidden">
                    <div className=" right-content absolute top-[29%] right-[15%]">
                        <img id="backRec" loading="lazy" className="absolute -top-[7%] animate-pulse  z-20" src="/public/images/hero/squers - option 1.svg" alt="" />
                        <div id="circle" className=" size-96 rounded-full bg-[#dfe1fa] relative z-10 overflow-hidden ">
                            <img id="myProfileImg" loading="lazy" className="absolute top-[50%] left-[50%]  -translate-x-[50%] -translate-y-[32%] z-20" src="/public/images/hero/myImg3.png" alt="" />
                        </div>
                    </div>
                </div>
                <div className="linesBack absolute top-[50%] left-[50%] size-full  -translate-x-[50%] -translate-y-[50%]">
                    <img className=" absolute w-full scale-y-[0.9] top-[180px]" src="/public/images/hero/Vector 1.png" alt="" />
                    <img className=" absolute w-full scale-y-[0.9] top-[248px]" src="/public/images/hero/Vector 3.png" alt="" />
                </div>
                <div className=" absolute bottom-0 border-dashed border-t-2 w-full z-30">
                    <img loading="lazy" className="absolute left-[50%]  -top-2.5" src="/public/images/hero/dot.png" alt="" />
                </div>
            </div>
        </section>
    )
