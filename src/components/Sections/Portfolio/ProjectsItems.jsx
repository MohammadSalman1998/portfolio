...
const items = [
    ...
    { id: 4, img: import.meta.env.BASE_URL+'images/Portfolio/weather.png', name: 'Weather App', langs: 'React js - css',date:'3/3/2025',
         desc:"weather app is an website application - build it by react js and API from 'openweathermap' to know 'Temp - Wind Speed - Humidity'", library:"react - axios", framework: "-", repoLink: "https://github.com/MohammadSalman1998/weather-app", demoLink:"https://mohammadsalman1998.github.io/weather-app/", link: '/' },
