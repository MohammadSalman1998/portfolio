...
const Education = () => {
    ...
    return (
        <section id="education" className={`relative  transition-all duration-300 ease-in ${isDark=='true' ? 'text-white bg-SubHeadBlack':' bg-white text-headBlack'}`}>
            <img className=" top-shape absolute right-0 " src="/public/images/education/Images bg.svg" alt="" />
            ...
            <img loading="lazy" className=" rotate-180" src="/public/images/education/Images bg.svg" alt="" />
        </section>
    )
}
